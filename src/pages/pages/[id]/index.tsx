...
const niches = [
  ...
  { label: "Parenting Blogger", value: "Parenting Blogger" },
  { label: "Finance Educator", value: "Finance Educator" },
  { label: "Comedy Creator", value: "Comedy Creator" },
...
const businesses = [
  ...
  { label: "Spa", value: "Spa" },
  { label: "Tattoo Parlor", value: "Tattoo Parlor" },
